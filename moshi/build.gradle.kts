...
kotlin.target.compilations.run {
  getByName("java16")
    .associateWith(getByName(org.jetbrains.kotlin.gradle.plugin.KotlinCompilation.MAIN_COMPILATION_NAME))
}
...
tasks.withType<Jar>().configureEach {
  manifest {
    attributes("Automatic-Module-Name" to "com.raoulsson.moshi")
  }
}
